...
public class EditorUtils {
    ...
    public static JsonObject getFileSelectionDetails(Editor editor, @NotNull PsiFile psiFile, boolean isCodeNote, String preText) {
        if (Objects.isNull(editor)) {
            ...
            parameters.addProperty("max_new_tokens", EasyCoderSettings.getInstance().getChatMaxToken().getDescription());
            ...
            if(EasyCoderSettings.getInstance().isCPURadioButtonEnabled()){
                returnObj.addProperty("sendUrl", EasyCoderSettings.getInstance().getServerAddressURL() + EasyCoderURI.CPU_CHAT.getUri());
                returnObj.addProperty("modelType", "CPU");
            }else{
                returnObj.addProperty("sendUrl", EasyCoderSettings.getInstance().getServerAddressURL() + EasyCoderURI.GPU_CHAT.getUri());
                returnObj.addProperty("modelType", "GPU");
            }
            returnObj.addProperty("maxToken", EasyCoderSettings.getInstance().getChatMaxToken().getDescription());
